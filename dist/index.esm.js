...
(function(){ if(typeof document !== 'undefined'){ var head=document.head||document.getElementsByTagName('head')[0], style=document.createElement('style'), css=".bv-accordions .bv-accordion .bv-accordion__content { margin-bottom: 0; } .bv-accordions .bv-accordion:last-child .bv-accordion__content { margin-bottom: 0.5rem; } .bv-accordion__header { display: flex; align-items: center; padding: 0.5rem 0; } .bv-accordion__toggle { flex-grow: 0; flex-shrink: 0; padding-right: 0.5rem; cursor: pointer; font-size: 0.75rem; } .bv-accordion__actions { flex-grow: 1; flex-shrink: 1; } .bv-accordion__title { flex-basis: 100%; flex-grow: 2; flex-shrink: 1; cursor: pointer; } .bv-accordion__title .title { margin: 0; line-height: 1; } .bv-accordion__content { margin-bottom: 0.5rem; } "; style.type='text/css'; if (style.styleSheet){ style.styleSheet.cssText = css; } else { style.appendChild(document.createTextNode(css)); } head.appendChild(style); } })();

var Accordion = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"bv-accordion",attrs:{"data-id":_vm.id,"data-state":_vm.state}},[_c('header',{staticClass:"bv-accordion__header"},[_c('div',{staticClass:"bv-accordion__toggle",on:{"click":_vm.toggle}},[(_vm.usesFontAwesome)?[_c('span',{staticClass:"icon"},[_c('i',{staticClass:"fas fal",class:[_vm.state ? 'fa-minus' : 'fa-plus']})])]:[_vm._v(_vm._s(_vm.state ? '-' : '+'))]],2),_vm._v(" "),_c('div',{staticClass:"bv-accordion__title",on:{"click":_vm.toggle}},[_vm._t("title")],2),_vm._v(" "),_c('div',{staticClass:"bv-accordion__actions"},[_vm._t("actions")],2)]),_vm._v(" "),(_vm.state)?_c('article',{staticClass:"bv-accordion__content content"},[_vm._t("content")],2):_vm._e()])},staticRenderFns: [],
    props: {
        usesFontAwesome: {
            default: true,
            type: Boolean,
